...
async function getStartManifest(matchedRoutes) {
  const { tsrStartManifest } = await import("../_tanstack-start-manifest_v-B0gX4nia.mjs");
...
const manifest = {
  "05fcbd90a800e6b8c7467d461972b06c1f3d6972ad52c7b32d94246990ff5094": {
    functionName: "generateCampaignReport_createServerFn_handler",
    importer: () => import("./gemini.functions-BAIIpgVC.mjs")
  },
  "0a00acb20f1e0b7fd78330d3278c7f5382bdaac1a61a29d4de1f1aaf26d097d4": {
    functionName: "checkCampaignSuitability_createServerFn_handler",
    importer: () => import("./gemini.functions-BAIIpgVC.mjs")
  },
  "797b608c0307735fa0b000541cfd06b460184d8f120ec6b795f304986089d851": {
    functionName: "getChatbotResponse_createServerFn_handler",
    importer: () => import("./gemini.functions-BAIIpgVC.mjs")
  },
  "8ebb6dc42575072b88991d85c764bf2829b85729e3e03d6e6f0e862b15012b29": {
    functionName: "simulateABTest_createServerFn_handler",
    importer: () => import("./gemini.functions-BAIIpgVC.mjs")
  },
  "eb681e496ce1a09726f89f56ab0e4d774f6a4c58d7d0c12c117914db1f033853": {
    functionName: "parseScreenshotData_createServerFn_handler",
    importer: () => import("./gemini.functions-BAIIpgVC.mjs")
  }
};
...
async function loadEntries() {
  const [routerEntry, startEntry, pluginAdapters] = await Promise.all([
    import("./router-LT1YDNfL.mjs").then((n) => n.r),
    import("./start-BoTHqsPd.mjs"),

import { p as pRetry, a as pRetryExports } from "./p-retry.mjs";
import { s as srcExports } from "./google-auth-library.mjs";
...
class BaseInteractions extends APIResource {
  ...
  get(id, params = {}, options) {
    ...
    const response = this._client.get(path`/${api_version}/interactions/${id}`, Object.assign(Object.assign({ query }, options), { stream: (_a2 = params === null || params === void 0 ? void 0 : params.stream) !== null && _a2 !== void 0 ? _a2 : false }));
...
class NodeAuth {
  constructor(opts) {
    ...
    this.googleAuth = new srcExports.GoogleAuth(vertexAuthOptions);
  }
